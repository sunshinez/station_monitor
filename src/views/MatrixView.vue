...
.top-nav {
  ...
  right: 0;
  height: 64px;
  background: color-mix(in srgb, var(--gs-bg-default), transparent 20%);
...
.status-dot.success {
  ...
  box-shadow: 0 0 12px var(--gs-glow-success);
}
...
.axis-label-top span {
  font-size: 10px;
  font-weight: 700;
  color: color-mix(in srgb, var(--gs-primary-main), transparent 40%);
  text-transform: uppercase;
