...
.dot-amber-glow {
  ...
  box-shadow: 0 0 2px var(--gs-warning-main), 0 0 10px var(--gs-glow-warning);
}
...
.push-detail-card {
  flex: 1;
  background: color-mix(in srgb, var(--gs-bg-elevated), transparent 60%);
...
.freq-bg-icon {
  ...
  width: 40px;
  height: 40px;
  color: color-mix(in srgb, var(--gs-primary-main), transparent 85%);
}
