<template>
  <div class="task-script-execution-page">
    <!-- 顶部导航栏 - 全局统一 -->
    ...
    <div class="main-layout">
      ...
      <aside class="side-nav">
        ...
        <nav class="side-menu">
          ...
          <router-link to="/task-script-execution" class="side-link active">
...
.border-success {
  border-bottom-color: rgba(74, 225, 118, 0.4);
}

.border-error {
  border-bottom-color: rgba(255, 180, 171, 0.4);
}
