...
.node-success:hover {
  border-color: rgba(0, 167, 75, 0.5);
}

.node-active {
  background: #F7F8FB;
  border: 2px solid #1C6AFF;
  box-shadow: 0 0 30px rgba(28, 106, 255, 0.15);
...
.arrow-line.success {
  background: linear-gradient(to right, #4ae176, #1C6AFF);
}

.arrow-line.primary {
  background: linear-gradient(to right, #1C6AFF, #1C6AFF);
}
