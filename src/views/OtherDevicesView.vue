    ...
    <aside class="side-nav">
      ...
      <nav class="side-menu">
        ...
        <div class="side-link-group">
          <div class="side-link active" @click="toggleSubMenu">
            <DevicesIcon class="side-icon" />
            <span>其它设备监视</span>
            <span class="expand-icon" :class="{ 'expanded': showSubMenu }">▼</span>
          </div>
          <div class="sub-menu" v-show="showSubMenu">
            <a
              ...
              @click.prevent="selectDevice(device.id)"
            >
...
.control-input:not([readonly]):focus {
  ...
  box-shadow: 0 0 0 2px rgba(164, 201, 255, 0.1);
}
